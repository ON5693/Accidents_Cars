...
var validateJWT = function (con) {
    var userRepo = con.getRepository(user_entity_1.User);
    return function (_a, request, h) {
        var id = _a.id;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { isValid: true, credentials: { user: user } }];
                }
            });
        });
    };
...
var validateBasic = function (con) {
    var userRepo = con.getRepository(user_entity_1.User);
    return function (request, username, password, h) { return __awaiter(void 0, void 0, void 0, function () {
        var user, isValid;

...
var vehicles_entity_1 = require("../entity/vehicles.entity");
var vehicleController = function (con) {
    var carsRepo = con.getRepository(vehicles_entity_1.Vehicles);
    return [
        {
            method: 'GET',
            path: '/vehicles',
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1: return [2 /*return*/, (_b.data = _c.sent(),
                                    _b.perPage = realTake,
                                    _b.page = +page || 1,
                                    _b.next = "http://localhost:3000/vehicles?perPage=".concat(realTake, "&page=").concat(+page + 1).concat(handleQuery),
                                    _b.prev = "http://localhost:3000/vehicles?perPage=".concat(realTake, "&page=").concat(+page - 1).concat(handleQuery),
                                    _b)];
                        }
                    });
                });
        ...
        },
        {
            ...
            handler: function (_a, h, err) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var createVehicleDto, v;
                    return __generator(this, function (_b) {
                        createVehicleDto = payload;
                        v = carsRepo.create(__assign({ userId: user.id }, createVehicleDto));

...
var userController = function (con) {
    ...
    return [
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                _b = {};
                                return [4 /*yield*/, userRepo.find(findOptions)];
                            case 1: return [2 /*return*/, (_b.data = _c.sent(),
                                    _b.perPage = realTake,
                                    _b.page = +page || 1,
                                    _b.next = "http://localhost:3000/users?perPage=".concat(realTake, "&page=").concat(+page + 1).concat(handleQuery),
                                    _b.prev = "http://localhost:3000/users?perPage=".concat(realTake, "&page=").concat(+page - 1).concat(handleQuery),
                                    _b)];
                        }
                    });
                });
        ...
        },
        {
            ...
            handler: function (_a, h, err) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var _b, firstName, lastName, email, document, driverLicense, u;
                    return __generator(this, function (_c) {
                        _b = payload, firstName = _b.firstName, lastName = _b.lastName, email = _b.email, document = _b.document, driverLicense = _b.driverLicense;
                        u = userRepo.create({
                            firstName: firstName,
                            lastName: lastName,
                            email: email,
            ...
            handler: function (request, h, err) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            u = _a.sent();
                            Object.keys(info).forEach(function (key) { return (u[key] = info[key]); });
